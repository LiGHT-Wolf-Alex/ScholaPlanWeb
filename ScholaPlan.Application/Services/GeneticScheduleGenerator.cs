...
/// </summary>
public class GeneticScheduleGenerator(ILogger<GeneticScheduleGenerator> logger) : IScheduleGenerator
{
        ...
        Dictionary<int, TeacherPreferences> teacherPreferences)
    {
        ...
        for (int generation = 0; generation < generations; generation++)
        {
            ...
            {
                logger.LogInformation($"Достигнута оптимальная приспособленность на поколении {generation}.");
                break;
            }
        ...
        List<double> fitnessScores, int tournamentSize = 5)
    {
        ...
        // Сортировка выбранных индексов по оценке
